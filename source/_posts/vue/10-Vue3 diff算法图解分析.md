...
本篇文章主要分析`Vue3 diff`算法，通过本文你可以知道：
...
![无key子序列](images/vue/diff/unkey.png)
...
![起始位置相同](images/vue/diff/key1.png)
...
![结束位置相同](images/vue/diff/key2.png)
...
![挂载新增节点](images/vue/diff/key3.png)
...
![卸载旧节点](images/vue/diff/key4.png)
...
![中间乱序，但有可复用节点](images/vue/diff/key5.png)

#### 2.5.1 为新子节点构建`key:index`映射

![构建key:index映射](images/vue/diff/key6.png)
...
![可复用交叉节点](images/vue/diff/交叉节点.png)
...
![最大递增子序列](images/vue/diff/递增序列.png)
...
![从右向左patch节点](images/vue/diff/key7.png)
...
![练习示例](images/vue/diff/练习.png)

图二 & 三：

![乱序情况示例](images/vue/diff/示例.png)

![乱序情况示例2](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9caf69416df140a69115c01333f84008~tplv-k3u1fbpfcp-zoom-1.awebp?)
